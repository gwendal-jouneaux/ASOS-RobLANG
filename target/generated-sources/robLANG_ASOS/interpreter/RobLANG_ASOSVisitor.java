...
public class RobLANG_ASOSVisitor implements fr.diverse.team.SEALS.lang.semantics.SelfAdaptiveVisitor {
	...
	public Object visitBreak(Break node, Object execCtx){ return (new robLANG_ASOS.operations.BreakOp()).execute(this,node,execCtx);}
	...
	public Object dispatch(fr.diverse.team.SEALS.lang.semantics.Node node, Object executionCtx){
		if(node instanceof Break){
			return visitBreak((Break) node, executionCtx);
		}
		return null;
	}
