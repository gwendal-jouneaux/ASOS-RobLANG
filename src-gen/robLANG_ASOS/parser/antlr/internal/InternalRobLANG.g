...
// Entry rule entryRuleMainDefinition
entryRuleMainDefinition returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getMainDefinitionRule()); }
	iv_ruleMainDefinition=ruleMainDefinition
	{ $current=$iv_ruleMainDefinition.current; }
	EOF;

// Rule MainDefinition
ruleMainDefinition returns [EObject current=null]
@init {
	enterRule();
}
@after {
	...
	(
		...
		{
			$current = $this_InlineMain_0.current;
			afterParserOrEnumRuleCall();
		}
		    |
		{
		...
		{
			$current = $this_ComplexMain_1.current;
			afterParserOrEnumRuleCall();
		}
	)
;

// Entry rule entryRuleInlineMain
entryRuleInlineMain returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getInlineMainRule()); }
	iv_ruleInlineMain=ruleInlineMain
	{ $current=$iv_ruleInlineMain.current; }
	EOF;

// Rule InlineMain
ruleInlineMain returns [EObject current=null]
@init {
	enterRule();
}
@after {
...
// Entry rule entryRuleComplexMain
entryRuleComplexMain returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getComplexMainRule()); }
	iv_ruleComplexMain=ruleComplexMain
	{ $current=$iv_ruleComplexMain.current; }
	EOF;

// Rule ComplexMain
ruleComplexMain returns [EObject current=null]
@init {
	enterRule();
}
@after {
...
@after {
	...
	(
		...
		{
			$current = $this_TradeOff_0.current;
			afterParserOrEnumRuleCall();
		}
		    |
		{
		...
		{
			$current = $this_Effector_6.current;
			afterParserOrEnumRuleCall();
		}
		    |
		{
		...
		{
			$current = $this_ArrayStatement_7.current;
			afterParserOrEnumRuleCall();
		}
		    |
		{
		...
		{
			$current = $this_BreakLoop_9.current;
			afterParserOrEnumRuleCall();
		}
		    |
		{
...
// Entry rule entryRuleBreakLoop
entryRuleBreakLoop returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getBreakLoopRule()); }
	iv_ruleBreakLoop=ruleBreakLoop
	{ $current=$iv_ruleBreakLoop.current; }
	EOF;

// Rule BreakLoop
ruleBreakLoop returns [EObject current=null]
@init {
	enterRule();
}
@after {
...
// Entry rule entryRuleTradeOff
entryRuleTradeOff returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getTradeOffRule()); }
	iv_ruleTradeOff=ruleTradeOff
	{ $current=$iv_ruleTradeOff.current; }
	EOF;

// Rule TradeOff
ruleTradeOff returns [EObject current=null]
@init {
	enterRule();
}
@after {
