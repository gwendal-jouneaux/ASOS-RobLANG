...
public class reduce_half_leftAdaptationRule extends AdaptationRule {
	@Override
	public Object adapt(SelfAdaptiveVisitor vis, AdaptableNode<? extends SemanticsAdaptationInterface> adaptableNode, Object execCtx, SemanticsAdaptationInterface config){
		...
		boolean validPatternInput227 = true && (data.getcomputed_angle() instanceof ValueDouble);
		if(validPatternInput227)
		{
			 // prelude
			...
			NilValue nilValue18 = SdFactory.eINSTANCE.createNilValue();
			NilValue out = nilValue18;
			result = out;
			 // prelude
