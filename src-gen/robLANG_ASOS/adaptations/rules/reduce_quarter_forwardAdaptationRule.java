...
public class reduce_quarter_forwardAdaptationRule extends AdaptationRule {
	@Override
	public Object adapt(SelfAdaptiveVisitor vis, AdaptableNode<? extends SemanticsAdaptationInterface> adaptableNode, Object execCtx, SemanticsAdaptationInterface config){
		...
		boolean validPatternInput221 = true && (data.getcomputed_distance() instanceof ValueDouble);
		if(validPatternInput221)
		{
			 // prelude
			...
			NilValue nilValue12 = SdFactory.eINSTANCE.createNilValue();
			NilValue out = nilValue12;
			result = out;
			 // prelude
