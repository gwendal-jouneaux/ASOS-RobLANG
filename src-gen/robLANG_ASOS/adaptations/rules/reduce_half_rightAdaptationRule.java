...
public class reduce_half_rightAdaptationRule extends AdaptationRule {
	@Override
	public Object adapt(SelfAdaptiveVisitor vis, AdaptableNode<? extends SemanticsAdaptationInterface> adaptableNode, Object execCtx, SemanticsAdaptationInterface config){
		...
		boolean validPatternInput228 = true && (data.getcomputed_angle() instanceof ValueDouble);
		if(validPatternInput228)
		{
			 // prelude
			...
			NilValue nilValue19 = SdFactory.eINSTANCE.createNilValue();
			NilValue out = nilValue19;
			result = out;
			 // prelude
