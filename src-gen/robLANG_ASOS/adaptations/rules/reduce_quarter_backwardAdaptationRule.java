...
public class reduce_quarter_backwardAdaptationRule extends AdaptationRule {
	@Override
	public Object adapt(SelfAdaptiveVisitor vis, AdaptableNode<? extends SemanticsAdaptationInterface> adaptableNode, Object execCtx, SemanticsAdaptationInterface config){
		...
		boolean validPatternInput222 = true && (data.getcomputed_distance() instanceof ValueDouble);
		if(validPatternInput222)
		{
			 // prelude
			...
			NilValue nilValue13 = SdFactory.eINSTANCE.createNilValue();
			NilValue out = nilValue13;
			result = out;
			 // prelude
