 ...
 * </p>
 * <ul>
 *   <li>{@link robLANG_ASOS.impl.ArrayLengthImpl#getArray <em>Array</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ArrayLengthImpl extends ArrayExpressionImpl implements ArrayLength {
	...
	protected EClass eStaticClass() {
		return RobLANG_ASOSPackage.Literals.ARRAY_LENGTH;
	}
	...
	public NotificationChain basicSetArray(Expression newArray, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					RobLANG_ASOSPackage.ARRAY_LENGTH__ARRAY, oldArray, newArray);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newArray != array) {
			...
			if (array != null)
				msgs = ((InternalEObject) array).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - RobLANG_ASOSPackage.ARRAY_LENGTH__ARRAY, null, msgs);
			if (newArray != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET, RobLANG_ASOSPackage.ARRAY_LENGTH__ARRAY, newArray,
					newArray));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
		case RobLANG_ASOSPackage.ARRAY_LENGTH__ARRAY:
