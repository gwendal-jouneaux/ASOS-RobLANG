 ...
 * </p>
 * <ul>
 *   <li>{@link robLANG_ASOS.impl.TypeImpl#getType <em>Type</em>}</li>
 *   <li>{@link robLANG_ASOS.impl.TypeImpl#getDimension <em>Dimension</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TypeImpl extends MinimalEObjectImpl.Container implements Type {
	...
	protected EClass eStaticClass() {
		return RobLANG_ASOSPackage.Literals.TYPE;
	}
	...
	public void setType(BasicType newType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RobLANG_ASOSPackage.TYPE__TYPE, oldType, type));
	}
	...
	public void setDimension(int newDimension) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RobLANG_ASOSPackage.TYPE__DIMENSION, oldDimension,
					dimension));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case RobLANG_ASOSPackage.TYPE__TYPE:
			return getType();
		case RobLANG_ASOSPackage.TYPE__DIMENSION:
			return getDimension();
		}
